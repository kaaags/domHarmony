...
var chgCount = document.getElementById("count").innerHTML = 8;

// 2. Target the div with the id of 'age' and change the contents to: "21 year old vibrant stud".

var chgAge = document.getElementById("age").innerHTML = "21 year old vibrant stud";

// 3. Target the span element with the id of "distance" and change the number from 1000 to 168.

var chgDistance = document.getElementById("distance").innerHTML = 168;
...
var node = document.createTextNode("My main objective is to find a Mrs. McDonald.");
